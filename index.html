...
<div id="wrapper-bgded-overlay-1" class="wrapper bgded overlay">
  <div id="pageintro" class="hoc clear"> 
    <article>
      <p class="heading">Информационни технологии</p>
      <h2 id="headin-2" class="heading"><span id="heading-2-span" class="block">Бъдещето е в </span> НАС !</h2>
      <footer><a id="footer-link" href="#">Прочети повече &raquo;</a></footer>
    </article>
  </div>
</div>
      ...
      <div class="table-row"> 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-key"></i></a>
            ...
            <p class="p-table-cell">Понятието „информационни технологии“ в съвременния си смисъл е използвано за пръв път през 1958 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-lastfm"></i></a>
            ...
            <p class="p-table-cell">В центъра на информационните технологии е информацията – тяхната основна задача е автоматизиране и систематизиране на работата 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-angellist"></i></a>
            ...
            <p class="p-table-cell">Информационните технологии използват за обработка и съхранение на информация електронноизчислителни машини – компютри. 
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      ...
      <p id="p-display-no" class="nospace">&fgdlgdgdfl gldfl gldfl glfld</p>
    </div>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div id="wrapper-bgded-overlay-2" class="wrapper bgded overlay">
  ...
  <section class="hoc container clear"> 
    ...
    <div class="group">
      <article class="one_third first"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="p-table-cell">По това време езикът и платформата Java, изградени върху същите концепции, се радват на огромен успех във всички сфери на разработката на софтуер и разработката на C# и .NET е естественият отговор на Microsoft срещу успехите на Java технологията.</p>
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="p-table-cell">Тъй като оригиналната версия на езика C# и платформата .NET са само за Windows се появява проекта Mono. 
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="p-table-cell">Mono сваля бариерите за създаване на качествен софтуер за Linux с езика C#. 
